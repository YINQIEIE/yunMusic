...
public class MovieDetailBean {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("MovieDetailBean{");
        sb.append("rating=").append(rating);
        sb.append(", reviews_count=").append(reviews_count);
        sb.append(", wish_count=").append(wish_count);
        sb.append(", douban_site='").append(douban_site).append('\'');
        sb.append(", year='").append(year).append('\'');
        sb.append(", images=").append(images);
        sb.append(", alt='").append(alt).append('\'');
        sb.append(", id='").append(id).append('\'');
        sb.append(", mobile_url='").append(mobile_url).append('\'');
        sb.append(", title='").append(title).append('\'');
        sb.append(", do_count=").append(do_count);
        sb.append(", share_url='").append(share_url).append('\'');
        sb.append(", seasons_count=").append(seasons_count);
        sb.append(", schedule_url='").append(schedule_url).append('\'');
        sb.append(", episodes_count=").append(episodes_count);
        sb.append(", collect_count=").append(collect_count);
        sb.append(", current_season='").append(current_season).append('\'');
        sb.append(", original_title='").append(original_title).append('\'');
        sb.append(", summary='").append(summary).append('\'');
        sb.append(", subtype='").append(subtype).append('\'');
        sb.append(", comments_count=").append(comments_count);
        sb.append(", ratings_count=").append(ratings_count);
        sb.append(", countries=").append(countries);
        sb.append(", genres=").append(genres);
        sb.append(", casts=").append(casts);
        sb.append(", directors=").append(directors);
        sb.append(", aka=").append(aka);
        sb.append('}');
        return sb.toString();
    }
}
